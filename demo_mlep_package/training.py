...
logging.basicConfig(filename="model_log.log", filemode="a", level=logging.INFO)
...
try:
    ...
    config2 = {
        "models": {
            "catencoder_file": None,
            "final_model_file": None,
            "full_pipln_transform": None,
            "imputer_file": None,
            "scaler_file": None,
        }
    }
    ...
    final_model_file = "finalmodel.pkl"
    scaler_file = "scaler.pkl"
    catencoder_file = "onehotencoder.pkl"
    full_pipln_path = "comb_transform.pkl"
...
config["models"]["scaler_file"] = scaler_file
config["models"]["catencoder_file"] = catencoder_file
config["models"]["full_pipln_transform"] = full_pipln_path
...
modelfolder = os.path.join("models")
